const projectData = {
    voiceSales: {
        ...
        title: "Голосовой AI-менеджер для стоматологии",
        ...
        video: {
            ...
            note: "В модалке подключено реальное демо с закрытой веб-камерой: разговор с пациентом, выбор времени и передача данных в CRM-сценарий."
        }
    },
    bitrixDispatcher: {
