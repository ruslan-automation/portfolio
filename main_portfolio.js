const projectData = {
    voiceSales: {
        ...
        highlights: [
            ...
            "Голосовой контур работает через Yandex SpeechKit, YandexGPT и сценарий в реальном времени: распознаёт речь, держит контекст и отвечает короткими живыми репликами.",
        ...
        architecture: [
            ...
            "Yandex SpeechKit, YandexGPT и агент в реальном времени обрабатывают голосовой диалог и удерживают контекст услуги, специалиста и времени.",
            "YCLIENTS, Bitrix24 и Postgres связывают расписание, запись, CRM-статус и журнал действий."
        ],
        stack: ["FastAPI", "Yandex SpeechKit", "YandexGPT", "YCLIENTS", "Bitrix24", "Postgres"],
