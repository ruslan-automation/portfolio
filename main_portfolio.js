const projectData = {
    voiceSales: {
        ...
        secondaryVideos: [
            {
                file: "0317_ai_admin_dentistry_cover.mp4",
                type: "video/mp4",
                title: "Дополнительное демо: звонок и CRM-сценарий",
                note: "Технический сценарий голосового агента с проверкой слотов и фиксацией лида в CRM. Видеокамера закрыта брендовой плашкой AI-администратора."
            }
        ]
    },
    bitrixDispatcher: {
